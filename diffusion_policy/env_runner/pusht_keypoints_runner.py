    ...
    def run(self, policy: BaseLowdimPolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            while not done:
                ...
                # excluding the first inference time for RTI
                if not first:
        ...
        print(f"Average inference time: {log_data['inference_time']:.5f} seconds")
        print(f"Max reward: {log_data['train/mean_max_score']:.5f} (train), {log_data['test/mean_max_score']:.5f} (test)")
